    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="content-container">
        ...
        <header className="contact-header">
          ...
          <p style={{color: "white"}}>We'd love to hear from you! Whether you need help with a knot tutorial, have a
        ...
        <div className="two-column-layout">
          ...
          <div className="left-column">
            <h2 className="section-title">Contact Information <hr /></h2>
          ...
          <div className="right-column">
            <div className="message-form">
              ...
              <p>Please fill in the information below to send a message.</p>
